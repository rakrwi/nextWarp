...
class TpaHereCommand(private val plugin: NextWarpPaper) : CommandExecutor, TabCompleter {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        if (args.isEmpty()) {
            sender.sendMessage(msg.tpa.hereUsage)
            return true
        }
        ...
        sender.sendMessage(msg.tpa.hereSent.replacePlaceholders("player" to exactTargetName))
        return true
    }
