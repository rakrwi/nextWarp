...
import dev.rakrwi.nextwarp.velocity.listener.PlayerConnectionListener
...
class NextWarpVelocity @Inject constructor(
    ...
    fun onProxyInitialize(event: ProxyInitializeEvent) {
        ...
        try {
            ...
            logger.error("Please check your config.json settings (Redis)")
            e.printStackTrace()
        }
    }
    ...
    private fun loadConfig() {
        config = VelocityConfigLoader.loadConfig(dataDirectory.toFile())
    }
